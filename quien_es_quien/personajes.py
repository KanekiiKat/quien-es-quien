...
integrantes = [
    ...
    Personajes("philip", caracteristicas=["negro", "pelonegro", "marrones", "cafe", "masculino", "hombre", "sonrisa", "felicidad", "barba", "orejasgrandes", "mofletes", "mejillassonrosadas", "cejasfinas", "pelocorto", "narizpequena"]),
